...
#define CASM_X32
    ...
    template<class t>
    inline constexpr const auto is_static_bytecode_v{ is_static_bytecode<std::decay_t<t>>::value };
    ...
    template<class t>
    inline constexpr const auto is_bytecode_v{ is_static_bytecode_v<t> or std::is_same_v<std::decay_t<t>, dynamic_bytecode_t> };
...
namespace casm
{
    ...
    constexpr decltype(auto) or_(details::al_t, details::imm8_t oper1) noexcept { using namespace details; return make_static_bytecode(0x0c) + make_imm(oper1); }
...
#ifdef CASM_X32
    constexpr decltype(auto) push(details::cs_t) noexcept { return details::make_static_bytecode(0x0e); }
#endif
    ...
    constexpr decltype(auto) adc(details::al_t, details::imm8_t oper1) noexcept { using namespace details; return make_static_bytecode(0x14) + make_imm(oper1); }
...
#ifdef CASM_X32
    constexpr decltype(auto) push(details::ss_t) noexcept { return details::make_static_bytecode(0x16); }

    constexpr decltype(auto) pop(details::ss_t) noexcept { return details::make_static_bytecode(0x17); }
#endif
    ...
    constexpr decltype(auto) sbb(details::al_t, details::imm8_t oper1) noexcept { using namespace details; return make_static_bytecode(0x1c) + make_imm(oper1); }
...
#ifdef CASM_X32
    constexpr decltype(auto) push(details::ds_t) noexcept { return details::make_static_bytecode(0x1e); }

    constexpr decltype(auto) pop(details::ds_t) noexcept { return details::make_static_bytecode(0x1f); }
#endif
    ...
    constexpr decltype(auto) and_(details::al_t, details::imm8_t oper1) noexcept { using namespace details; return make_static_bytecode(0x24) + make_imm(oper1); }
...
#ifdef CASM_X32
    constexpr decltype(auto) daa() noexcept { using namespace details; return details::make_static_bytecode(0x27); }
#endif
    ...
    constexpr decltype(auto) sub(details::al_t, details::imm8_t oper1) noexcept { using namespace details; return make_static_bytecode(0x2c) + make_imm(oper1); }
...
#ifdef CASM_X32
    constexpr decltype(auto) das() noexcept { using namespace details; return details::make_static_bytecode(0x2f); }
#endif
    ...
    constexpr decltype(auto) xor_(details::al_t, details::imm8_t oper1) noexcept { using namespace details; return make_static_bytecode(0x34) + make_imm(oper1); }
...
#ifdef CASM_X32
    constexpr decltype(auto) aaa() noexcept { using namespace details; return details::make_static_bytecode(0x37); }
#endif
    ...
    constexpr decltype(auto) cmp(details::al_t, details::imm8_t oper1) noexcept { using namespace details; return make_static_bytecode(0x3c) + make_imm(oper1); }
...
#ifdef CASM_X32
    constexpr decltype(auto) aas() noexcept { using namespace details; return details::make_static_bytecode(0x3f); }

    template<class oper0_t, std::enable_if_t<details::is_r16_32_v<oper0_t>, std::nullptr_t> = nullptr> constexpr decltype(auto) inc(oper0_t r) noexcept { using namespace details; auto opcode = make_static_bytecode(0x40); opcode.at(opcode.size() - 1) += r.n(); return make_oper_size_prefix(r) + opcode; }

    template<class oper0_t, std::enable_if_t<details::is_r16_32_v<oper0_t>, std::nullptr_t> = nullptr> constexpr decltype(auto) dec(oper0_t r) noexcept { using namespace details; auto opcode = make_static_bytecode(0x48); opcode.at(opcode.size() - 1) += r.n(); return make_oper_size_prefix(r) + opcode; }

    template<class oper0_t, std::enable_if_t<details::is_r16_32_v<oper0_t>, std::nullptr_t> = nullptr> constexpr decltype(auto) push(oper0_t r) noexcept { using namespace details; auto opcode = make_static_bytecode(0x50); opcode.at(opcode.size() - 1) += r.n(); return make_oper_size_prefix(r) + opcode; }

    template<class oper0_t, std::enable_if_t<details::is_r16_32_v<oper0_t>, std::nullptr_t> = nullptr> constexpr decltype(auto) pop(oper0_t r) noexcept { using namespace details; auto opcode = make_static_bytecode(0x58); opcode.at(opcode.size() - 1) += r.n(); return make_oper_size_prefix(r) + opcode; }

    constexpr decltype(auto) pusha() noexcept { using namespace details; return details::make_static_bytecode(0x60); }

    constexpr decltype(auto) pushad() noexcept { using namespace details; return details::make_static_bytecode(0x60); }

    constexpr decltype(auto) popa() noexcept { using namespace details; return details::make_static_bytecode(0x61); }

    constexpr decltype(auto) popad() noexcept { using namespace details; return details::make_static_bytecode(0x61); }
#endif

#ifdef CASM_X64
    template<class oper0_t, std::enable_if_t<details::is_r16_64_v<oper0_t>, std::nullptr_t> = nullptr> constexpr decltype(auto) push(oper0_t r) noexcept { using namespace details; auto opcode = make_static_bytecode(0x50); opcode.at(opcode.size() - 1) += r.n(); return make_oper_size_prefix(r) + make_rex_w(r) + opcode; }

    template<class oper0_t, std::enable_if_t<details::is_r16_64_v<oper0_t>, std::nullptr_t> = nullptr> constexpr decltype(auto) pop(oper0_t r) noexcept { using namespace details; auto opcode = make_static_bytecode(0x58); opcode.at(opcode.size() - 1) += r.n(); return make_oper_size_prefix(r) + make_rex_w(r) + opcode; }
#endif

    template<class oper0_t, class oper1_t, std::enable_if_t<details::is_r32_64_v<oper0_t> and details::is_rm32_v<oper1_t>, std::nullptr_t> = nullptr> constexpr decltype(auto) movsxd(oper0_t oper0, oper1_t const& oper1) noexcept { using namespace details; return make_segment_prefix(oper1) + make_address_size_prefix(oper1) + make_rex(oper1, oper0) + make_static_bytecode(0x63) + make_modrm_sib(oper1, oper0); }

    template<class oper0_t, std::enable_if_t<details::is_imm32_v<oper0_t>, std::nullptr_t> = nullptr> constexpr decltype(auto) push(oper0_t oper0) noexcept { using namespace details; return make_static_bytecode(0x68) + make_imm(oper0); }
    ...
    constexpr decltype(auto) push(details::imm8_t imm) noexcept { using namespace details; return make_static_bytecode(0x6a) + make_imm(imm); }
    ...
    constexpr decltype(auto) ins() noexcept { using namespace details; return details::make_static_bytecode(0x6c); }

    constexpr decltype(auto) insb() noexcept { using namespace details; return details::make_static_bytecode(0x6c); }

    constexpr decltype(auto) insw() noexcept { using namespace details; return details::make_static_bytecode(0x66, 0x6d); }

    constexpr decltype(auto) insd() noexcept { using namespace details; return details::make_static_bytecode(0x6d); }

    constexpr decltype(auto) outsb() noexcept { using namespace details; return details::make_static_bytecode(0x6e); }

    constexpr decltype(auto) outsw() noexcept { using namespace details; return details::make_static_bytecode(0x66, 0x6f); }

    constexpr decltype(auto) outsd() noexcept { using namespace details; return details::make_static_bytecode(0x6f); }
    ...
    template<class oper0_t, class oper1_t, std::enable_if_t<details::is_r8_v<oper0_t> and details::is_r8_v<oper1_t>, std::nullptr_t> = nullptr> constexpr decltype(auto) xchg(oper0_t oper0, oper1_t oper1) noexcept { using namespace details; return make_rex(oper0, oper1) + make_static_bytecode(0x86) + make_modrm_sib(oper1, oper0); }
    ...
    template<class oper0_t, std::enable_if_t<details::is_r16_32_64_v<oper0_t>, std::nullptr_t> = nullptr> constexpr decltype(auto) mov(oper0_t oper0, details::sreg oper1) noexcept { using namespace details; return make_oper_size_prefix(oper0) + make_static_bytecode(0x8c) + make_modrm_sib(oper0, oper1); }

    template<class oper0_t, class oper1_t, std::enable_if_t<details::is_r16_32_64_v<oper0_t> and details::is_m_v<oper1_t>, std::nullptr_t> = nullptr> constexpr decltype(auto) lea(oper0_t oper0, oper1_t const& oper1) noexcept { using namespace details; return make_segment_prefix(oper1) + make_oper_size_prefix(oper0) + make_address_size_prefix(oper1) + make_rex(oper1, oper0) + make_static_bytecode(0x8d) + make_modrm_sib(oper1, oper0); }

    template<class oper1_t, std::enable_if_t<details::is_rm16_v<oper1_t>, std::nullptr_t> = nullptr> constexpr decltype(auto) mov(details::sreg oper0, oper1_t const& oper1) noexcept { using namespace details; return make_segment_prefix(oper1) + make_address_size_prefix(oper1) + make_rex(oper1) + make_static_bytecode(0x8e) + make_modrm_sib(oper1, oper0); }
    ...
    template<class oper0_t, class oper1_t, std::enable_if_t<details::is_r16_32_64_v<oper0_t> and details::is_ax_eax_rax_v<oper1_t>, std::nullptr_t> = nullptr> constexpr decltype(auto) xchg(oper0_t r, oper1_t) noexcept { using namespace details; static_assert(is_same_oper_size_v<oper0_t, oper1_t>); auto opcode = make_static_bytecode(0x90); opcode.at(opcode.size() - 1) += r.n(); return make_oper_size_prefix(r) + make_rex(r) + opcode; }

    constexpr decltype(auto) nop() noexcept { using namespace details; return details::make_static_bytecode(0x90); }

    constexpr decltype(auto) pause_() noexcept { using namespace details; return details::make_static_bytecode(0xf3, 0x90); }

    constexpr decltype(auto) cbw() noexcept { using namespace details; return details::make_static_bytecode(0x66, 0x98); }

    constexpr decltype(auto) cwde() noexcept { using namespace details; return details::make_static_bytecode(0x98); }

#ifdef CASM_X64
    constexpr decltype(auto) cdqe() noexcept { using namespace details; return details::make_static_bytecode(0x48, 0x98); }
#endif

    constexpr decltype(auto) cwd() noexcept { using namespace details; return details::make_static_bytecode(0x66, 0x99); }

    constexpr decltype(auto) cdq() noexcept { using namespace details; return details::make_static_bytecode(0x99); }

#ifdef CASM_X64
    constexpr decltype(auto) cqo() noexcept { using namespace details; return details::make_static_bytecode(0x48, 0x99); }
#endif

    constexpr decltype(auto) fwait() noexcept { using namespace details; return details::make_static_bytecode(0x9b); }

    constexpr decltype(auto) wait() noexcept { using namespace details; return details::make_static_bytecode(0x9b); }

    constexpr decltype(auto) pushf() noexcept { using namespace details; return details::make_static_bytecode(0x9c); }

    constexpr decltype(auto) pushfq() noexcept { using namespace details; return details::make_static_bytecode(0x9c); }

    constexpr decltype(auto) popf() noexcept { using namespace details; return details::make_static_bytecode(0x9d); }

    constexpr decltype(auto) popfq() noexcept { using namespace details; return details::make_static_bytecode(0x9d); }

    constexpr decltype(auto) sahf() noexcept { using namespace details; return details::make_static_bytecode(0x9e); }

    constexpr decltype(auto) lahf() noexcept { using namespace details; return details::make_static_bytecode(0x9f); }

    constexpr decltype(auto) movsb() noexcept { using namespace details; return details::make_static_bytecode(0xa4); }

    constexpr decltype(auto) movsw() noexcept { using namespace details; return details::make_static_bytecode(0x66, 0xa5); }

    constexpr decltype(auto) movsd() noexcept { using namespace details; return details::make_static_bytecode(0xa5); }

#ifdef CASM_X64
    constexpr decltype(auto) movsq() noexcept { using namespace details; return details::make_static_bytecode(0x48, 0xa5); }
#endif

    constexpr decltype(auto) cmpsb() noexcept { using namespace details; return details::make_static_bytecode(0xa6); }

    constexpr decltype(auto) cmpsw() noexcept { using namespace details; return details::make_static_bytecode(0x66, 0xa7); }

    constexpr decltype(auto) cmpsd() noexcept { using namespace details; return details::make_static_bytecode(0xa7); }

#ifdef CASM_X64
    constexpr decltype(auto) cmpsq() noexcept { using namespace details; return details::make_static_bytecode(0x48, 0xa7); }
#endif

    constexpr decltype(auto) test(details::al_t, details::imm8_t oper1) noexcept { using namespace details; return make_static_bytecode(0xa8) + make_imm(oper1); }
    ...
    constexpr decltype(auto) stosb() noexcept { using namespace details; return details::make_static_bytecode(0xaa); }

    constexpr decltype(auto) stosw() noexcept { using namespace details; return details::make_static_bytecode(0x66, 0xab); }

    constexpr decltype(auto) stosd() noexcept { using namespace details; return details::make_static_bytecode(0xab); }

#ifdef CASM_X64
    constexpr decltype(auto) stosq() noexcept { using namespace details; return details::make_static_bytecode(0x48, 0xab); }
#endif

    constexpr decltype(auto) lodsb() noexcept { using namespace details; return details::make_static_bytecode(0xac); }

    constexpr decltype(auto) lodsw() noexcept { using namespace details; return details::make_static_bytecode(0x66, 0xad); }

    constexpr decltype(auto) lodsd() noexcept { using namespace details; return details::make_static_bytecode(0xad); }

#ifdef CASM_X64
    constexpr decltype(auto) lodsq() noexcept { using namespace details; return details::make_static_bytecode(0x48, 0xad); }
#endif

    constexpr decltype(auto) scasb() noexcept { using namespace details; return details::make_static_bytecode(0xae); }

    constexpr decltype(auto) scasw() noexcept { using namespace details; return details::make_static_bytecode(0x66, 0xaf); }

    constexpr decltype(auto) scasd() noexcept { using namespace details; return details::make_static_bytecode(0xaf); }

#ifdef CASM_X64
    constexpr decltype(auto) scasq() noexcept { using namespace details; return details::make_static_bytecode(0x48, 0xaf); }
#endif

    template<class oper0_t, std::enable_if_t<details::is_r8_v<oper0_t>, std::nullptr_t> = nullptr> constexpr decltype(auto) mov(oper0_t r, details::imm8_t oper1) noexcept { using namespace details; auto opcode = make_static_bytecode(0xb0); opcode.at(opcode.size() - 1) += r.n(); return make_rex(r) + opcode + make_imm(oper1); }

    template<class oper0_t, class oper1_t, std::enable_if_t<details::is_r16_32_v<oper0_t> and details::is_imm16_32_v<oper1_t>, std::nullptr_t> = nullptr> constexpr decltype(auto) mov(oper0_t r, oper1_t oper1) noexcept { using namespace details; auto opcode = make_static_bytecode(0xb8); opcode.at(opcode.size() - 1) += r.n(); return make_oper_size_prefix(r) + make_rex(r) + opcode + make_imm(oper1, r); }

#ifdef CASM_X64
    template<class oper0_t, std::enable_if_t<details::is_r64_v<oper0_t>, std::nullptr_t> = nullptr> constexpr decltype(auto) mov(oper0_t r, details::imm64_t oper1) noexcept { using namespace details; auto opcode = make_static_bytecode(0xb8); opcode.at(opcode.size() - 1) += r.n(); return make_rex(r) + opcode + to_static_bytecode(oper1); }

    template<class oper0_t, class t, std::enable_if_t<details::is_r64_v<oper0_t> and !details::is_m_v<t> and !details::is_r_v<t> and !details::is_imm_v<t>, std::nullptr_t> = nullptr> constexpr decltype(auto) mov(oper0_t r, t const& ref) noexcept { using namespace details; auto opcode = make_static_bytecode(0xb8); opcode.at(opcode.size() - 1) += r.n(); return make_rex(r) + opcode + to_static_bytecode(ref); }
#endif
    ...
    constexpr decltype(auto) retn(details::imm16_t oper) noexcept { using namespace details; return make_static_bytecode(0xc2) + make_imm(oper); }

    constexpr decltype(auto) ret() noexcept { using namespace details; return details::make_static_bytecode(0xc3); }

#ifdef CASM_X32
    template<class oper0_t, class oper1_t, std::enable_if_t<details::is_r16_32_v<oper0_t> and details::is_m16_48_v<oper1_t>, std::nullptr_t> = nullptr> constexpr decltype(auto) les(oper0_t oper0, oper1_t const& oper1) noexcept { using namespace details; return make_segment_prefix(oper1) + make_address_size_prefix(oper1) + make_static_bytecode(0xc4) + make_modrm_sib(oper1, oper0); }
    ...
    constexpr decltype(auto) enter(details::imm16_t oper0, details::imm8_t oper1) noexcept { using namespace details; return make_static_bytecode(0xc8) + make_imm(oper0) + make_imm(oper1); }

    constexpr decltype(auto) leave() noexcept { using namespace details; return details::make_static_bytecode(0xc9); }

    constexpr decltype(auto) retf(details::imm16_t oper) noexcept { using namespace details; return make_static_bytecode(0xca) + make_imm(oper); }

    constexpr decltype(auto) retf() noexcept { using namespace details; return details::make_static_bytecode(0xcb); }

    constexpr decltype(auto) int3() noexcept { using namespace details; return details::make_static_bytecode(0xcc); }

    constexpr decltype(auto) int_(details::imm8_t imm) noexcept { using namespace details; return make_static_bytecode(0xcd) + make_imm(imm); }

#ifdef CASM_X32
    constexpr decltype(auto) into() noexcept { using namespace details; return details::make_static_bytecode(0xce); }
#endif

    constexpr decltype(auto) iret() noexcept { using namespace details; return details::make_static_bytecode(0xcf); }

    constexpr decltype(auto) iretd() noexcept { using namespace details; return details::make_static_bytecode(0xcf); }

#ifdef CASM_X64
    constexpr decltype(auto) iretq() noexcept { using namespace details; return details::make_static_bytecode(0x48, 0xcf); }
#endif
...
#ifdef CASM_X32
    constexpr decltype(auto) aam() noexcept { using namespace details; return details::make_static_bytecode(0xd4, 0x0a); }

    constexpr decltype(auto) aam(details::imm8_t imm) noexcept { using namespace details; return make_static_bytecode(0xd4) + make_imm(imm); }

    constexpr decltype(auto) amx(details::imm8_t imm) noexcept { using namespace details; return make_static_bytecode(0xd4) + make_imm(imm); }

    constexpr decltype(auto) aad() noexcept { using namespace details; return details::make_static_bytecode(0xd5, 0x0a); }

    constexpr decltype(auto) aad(details::imm8_t imm) noexcept { using namespace details; return make_static_bytecode(0xd4) + make_imm(imm); }

    constexpr decltype(auto) adx(details::imm8_t imm) noexcept { using namespace details; return make_static_bytecode(0xd4) + make_imm(imm); }

    constexpr decltype(auto) salc() noexcept { using namespace details; return details::make_static_bytecode(0xd6); }

    constexpr decltype(auto) setalc() noexcept { using namespace details; return details::make_static_bytecode(0xd6); }
#endif

    constexpr decltype(auto) xlat() noexcept { using namespace details; return details::make_static_bytecode(0xd7); }

    constexpr decltype(auto) xlatb() noexcept { using namespace details; return details::make_static_bytecode(0xd7); }
    ...
    constexpr decltype(auto) fadd(details::st oper0) noexcept { using namespace details; return make_static_bytecode(0xd8) + make_modrm_sib(oper0, reg_bits{ 0 }); }

    constexpr decltype(auto) fadd(details::st0_t, details::st oper0) noexcept { using namespace details; return make_static_bytecode(0xd8) + make_modrm_sib(oper0, reg_bits{ 0 }); }
    ...
    constexpr decltype(auto) fmul(details::st oper0) noexcept { using namespace details; return make_static_bytecode(0xd8) + make_modrm_sib(oper0, reg_bits{ 1 }); }

    constexpr decltype(auto) fmul(details::st0_t, details::st oper0) noexcept { using namespace details; return make_static_bytecode(0xd8) + make_modrm_sib(oper0, reg_bits{ 1 }); }
    ...
    constexpr decltype(auto) fcom() noexcept { using namespace details; return details::make_static_bytecode(0xd8, 0xd1); }
    ...
    constexpr decltype(auto) fcomp() noexcept { using namespace details; return details::make_static_bytecode(0xd8, 0xd9); }
    ...
    constexpr decltype(auto) fsub(details::st oper0) noexcept { using namespace details; return make_static_bytecode(0xd8) + make_modrm_sib(oper0, reg_bits{ 4 }); }

    constexpr decltype(auto) fsub(details::st0_t, details::st oper0) noexcept { using namespace details; return make_static_bytecode(0xd8) + make_modrm_sib(oper0, reg_bits{ 4 }); }
    ...
    constexpr decltype(auto) fsubr(details::st oper0) noexcept { using namespace details; return make_static_bytecode(0xd8) + make_modrm_sib(oper0, reg_bits{ 5 }); }

    constexpr decltype(auto) fsubr(details::st0_t, details::st oper0) noexcept { using namespace details; return make_static_bytecode(0xd8) + make_modrm_sib(oper0, reg_bits{ 5 }); }
    ...
    constexpr decltype(auto) fdiv(details::st oper0) noexcept { using namespace details; return make_static_bytecode(0xd8) + make_modrm_sib(oper0, reg_bits{ 6 }); }

    constexpr decltype(auto) fdiv(details::st0_t, details::st oper0) noexcept { using namespace details; return make_static_bytecode(0xd8) + make_modrm_sib(oper0, reg_bits{ 6 }); }
    ...
    constexpr decltype(auto) fdivr(details::st oper0) noexcept { using namespace details; return make_static_bytecode(0xd8) + make_modrm_sib(oper0, reg_bits{ 7 }); }

    constexpr decltype(auto) fdivr(details::st0_t, details::st oper0) noexcept { using namespace details; return make_static_bytecode(0xd8) + make_modrm_sib(oper0, reg_bits{ 7 }); }
    ...
    constexpr decltype(auto) fxch(details::st oper0) noexcept { using namespace details; return make_static_bytecode(0xd9) + make_modrm_sib(oper0, reg_bits{ 1 }); }

    constexpr decltype(auto) fxch() noexcept { using namespace details; return details::make_static_bytecode(0xd9, 0xc9); }
    ...
    constexpr decltype(auto) fnop() noexcept { using namespace details; return details::make_static_bytecode(0xd9, 0xd0); }
    ...
    constexpr decltype(auto) fchs() noexcept { using namespace details; return details::make_static_bytecode(0xd9, 0xe0); }

    constexpr decltype(auto) fabs() noexcept { using namespace details; return details::make_static_bytecode(0xd9, 0xe1); }

    constexpr decltype(auto) ftst() noexcept { using namespace details; return details::make_static_bytecode(0xd9, 0xe4); }

    constexpr decltype(auto) fxam() noexcept { using namespace details; return details::make_static_bytecode(0xd9, 0xe5); }
    ...
    constexpr decltype(auto) fld1() noexcept { using namespace details; return details::make_static_bytecode(0xd9, 0xe8); }

    constexpr decltype(auto) fldl2t() noexcept { using namespace details; return details::make_static_bytecode(0xd9, 0xe9); }

    constexpr decltype(auto) fldl2e() noexcept { using namespace details; return details::make_static_bytecode(0xd9, 0xea); }

    constexpr decltype(auto) fldpi() noexcept { using namespace details; return details::make_static_bytecode(0xd9, 0xeb); }

    constexpr decltype(auto) fldlg2() noexcept { using namespace details; return details::make_static_bytecode(0xd9, 0xec); }

    constexpr decltype(auto) fldln2() noexcept { using namespace details; return details::make_static_bytecode(0xd9, 0xed); }

    constexpr decltype(auto) fldz() noexcept { using namespace details; return details::make_static_bytecode(0xd9, 0xee); }
    ...
    template<class oper0_t, std::enable_if_t<details::is_m_v<oper0_t>, std::nullptr_t> = nullptr> constexpr decltype(auto) fstenv(oper0_t const& oper0) noexcept { using namespace details; return make_segment_prefix(oper0) + make_address_size_prefix(oper0) + 0x9b + make_rex(oper0) + make_static_bytecode(0xd9) + make_modrm_sib(oper0, reg_bits{ 6 }); }

    constexpr decltype(auto) f2xm1() noexcept { using namespace details; return details::make_static_bytecode(0xd9, 0xf0); }

    constexpr decltype(auto) fyl2x() noexcept { using namespace details; return details::make_static_bytecode(0xd9, 0xf1); }

    constexpr decltype(auto) fptan() noexcept { using namespace details; return details::make_static_bytecode(0xd9, 0xf2); }

    constexpr decltype(auto) fpatan() noexcept { using namespace details; return details::make_static_bytecode(0xd9, 0xf3); }

    constexpr decltype(auto) fxtract() noexcept { using namespace details; return details::make_static_bytecode(0xd9, 0xf4); }

    constexpr decltype(auto) fprem1() noexcept { using namespace details; return details::make_static_bytecode(0xd9, 0xf5); }

    constexpr decltype(auto) fdecstp() noexcept { using namespace details; return details::make_static_bytecode(0xd9, 0xf6); }

    constexpr decltype(auto) fincstp() noexcept { using namespace details; return details::make_static_bytecode(0xd9, 0xf7); }
    ...
    template<class oper0_t, std::enable_if_t<details::is_m16_v<oper0_t>, std::nullptr_t> = nullptr> constexpr decltype(auto) fstcw(oper0_t const& oper0) noexcept { using namespace details; return make_segment_prefix(oper0) + make_address_size_prefix(oper0) + make_static_bytecode(0x9b) + make_rex(oper0) + make_static_bytecode(0xd9) + make_modrm_sib(oper0, reg_bits{ 7 }); }

    constexpr decltype(auto) fprem() noexcept { using namespace details; return details::make_static_bytecode(0xd9, 0xf8); }

    constexpr decltype(auto) fyl2xp1() noexcept { using namespace details; return details::make_static_bytecode(0xd9, 0xf9); }

    constexpr decltype(auto) fsqrt() noexcept { using namespace details; return details::make_static_bytecode(0xd9, 0xfa); }

    constexpr decltype(auto) fsincos() noexcept { using namespace details; return details::make_static_bytecode(0xd9, 0xfb); }

    constexpr decltype(auto) frndint() noexcept { using namespace details; return details::make_static_bytecode(0xd9, 0xfc); }

    constexpr decltype(auto) fscale() noexcept { using namespace details; return details::make_static_bytecode(0xd9, 0xfd); }

    constexpr decltype(auto) fsin() noexcept { using namespace details; return details::make_static_bytecode(0xd9, 0xfe); }

    constexpr decltype(auto) fcos() noexcept { using namespace details; return details::make_static_bytecode(0xd9, 0xff); }
    ...
    constexpr decltype(auto) fcmovb(details::st oper0) noexcept { using namespace details; return make_static_bytecode(0xda) + make_modrm_sib(oper0, reg_bits{ 0 }); }
    ...
    constexpr decltype(auto) fcmove(details::st oper0) noexcept { using namespace details; return make_static_bytecode(0xda) + make_modrm_sib(oper0, reg_bits{ 1 }); }
    ...
    constexpr decltype(auto) fcmovbe(details::st oper0) noexcept { using namespace details; return make_static_bytecode(0xda) + make_modrm_sib(oper0, reg_bits{ 2 }); }
    ...
    constexpr decltype(auto) fcmovu(details::st oper0) noexcept { using namespace details; return make_static_bytecode(0xda) + make_modrm_sib(oper0, reg_bits{ 3 }); }
    ...
    constexpr decltype(auto) fucompp() noexcept { using namespace details; return details::make_static_bytecode(0xda, 0xe9); }
    ...
    constexpr decltype(auto) fcmovnb(details::st oper0) noexcept { using namespace details; return make_static_bytecode(0xdb) + make_modrm_sib(oper0, reg_bits{ 0 }); }
    ...
    constexpr decltype(auto) fcmovne(details::st oper0) noexcept { using namespace details; return make_static_bytecode(0xdb) + make_modrm_sib(oper0, reg_bits{ 1 }); }
    ...
    constexpr decltype(auto) fcmovnbe(details::st oper0) noexcept { using namespace details; return make_static_bytecode(0xdb) + make_modrm_sib(oper0, reg_bits{ 2 }); }
    ...
    constexpr decltype(auto) fcmovnu(details::st oper0) noexcept { using namespace details; return make_static_bytecode(0xdb) + make_modrm_sib(oper0, reg_bits{ 3 }); }

    constexpr decltype(auto) fneni() noexcept { using namespace details; return details::make_static_bytecode(0xdb, 0xe0); }

    constexpr decltype(auto) fndisi() noexcept { using namespace details; return details::make_static_bytecode(0xdb, 0xe1); }

    constexpr decltype(auto) fnclex() noexcept { using namespace details; return details::make_static_bytecode(0xdb, 0xe2); }

    constexpr decltype(auto) fclex() noexcept { using namespace details; return details::make_static_bytecode(0x9b, 0xdb, 0xe2); }

    constexpr decltype(auto) fninit() noexcept { using namespace details; return details::make_static_bytecode(0xdb, 0xe3); }

    constexpr decltype(auto) finit() noexcept { using namespace details; return details::make_static_bytecode(0x9b, 0xdb, 0xe3); }
    ...
    constexpr decltype(auto) fucomi(details::st oper0) noexcept { using namespace details; return make_static_bytecode(0xdb) + make_modrm_sib(oper0, reg_bits{ 5 }); }

    constexpr decltype(auto) fcomi(details::st oper0) noexcept { using namespace details; return make_static_bytecode(0xdb) + make_modrm_sib(oper0, reg_bits{ 6 }); }
    ...
    constexpr decltype(auto) fadd(details::st oper0, details::st0_t) noexcept { using namespace details; return make_static_bytecode(0xdc) + make_modrm_sib(oper0, reg_bits{ 0 }); }
    ...
    constexpr decltype(auto) fmul(details::st oper0, details::st0_t) noexcept { using namespace details; return make_static_bytecode(0xdc) + make_modrm_sib(oper0, reg_bits{ 1 }); }
    ...
    constexpr decltype(auto) fsubr(details::st oper0, details::st0_t) noexcept { using namespace details; return make_static_bytecode(0xdc) + make_modrm_sib(oper0, reg_bits{ 4 }); }
    ...
    constexpr decltype(auto) fsub(details::st oper0, details::st0_t) noexcept { using namespace details; return make_static_bytecode(0xdc) + make_modrm_sib(oper0, reg_bits{ 5 }); }
    ...
    constexpr decltype(auto) fdivr(details::st oper0, details::st0_t) noexcept { using namespace details; return make_static_bytecode(0xdc) + make_modrm_sib(oper0, reg_bits{ 6 }); }
    ...
    constexpr decltype(auto) fdiv(details::st oper0, details::st0_t) noexcept { using namespace details; return make_static_bytecode(0xdc) + make_modrm_sib(oper0, reg_bits{ 7 }); }
    ...
    constexpr decltype(auto) ffree(details::st oper0) noexcept { using namespace details; return make_static_bytecode(0xdd) + make_modrm_sib(oper0, reg_bits{ 0 }); }
    ...
    constexpr decltype(auto) fst(details::st oper0) noexcept { using namespace details; return make_static_bytecode(0xdd) + make_modrm_sib(oper0, reg_bits{ 2 }); }
    ...
    constexpr decltype(auto) fucom(details::st oper0) noexcept { using namespace details; return make_static_bytecode(0xdd) + make_modrm_sib(oper0, reg_bits{ 4 }); }

    constexpr decltype(auto) fucom() noexcept { using namespace details; return details::make_static_bytecode(0xdd, 0xe1); }

    constexpr decltype(auto) fucomp(details::st oper0) noexcept { using namespace details; return make_static_bytecode(0xdd) + make_modrm_sib(oper0, reg_bits{ 5 }); }

    constexpr decltype(auto) fucomp() noexcept { using namespace details; return details::make_static_bytecode(0xdd, 0xe9); }
    ...
    constexpr decltype(auto) faddp(details::st oper0) noexcept { using namespace details; return make_static_bytecode(0xde) + make_modrm_sib(oper0, reg_bits{ 0 }); }

    constexpr decltype(auto) faddp() noexcept { using namespace details; return details::make_static_bytecode(0xde, 0xc1); }
    ...
    constexpr decltype(auto) fmulp(details::st oper0) noexcept { using namespace details; return make_static_bytecode(0xde) + make_modrm_sib(oper0, reg_bits{ 1 }); }

    constexpr decltype(auto) fmulp() noexcept { using namespace details; return details::make_static_bytecode(0xde, 0xc9); }
    ...
    constexpr decltype(auto) fcompp() noexcept { using namespace details; return details::make_static_bytecode(0xde, 0xd9); }
    ...
    constexpr decltype(auto) fsubrp(details::st oper0) noexcept { using namespace details; return make_static_bytecode(0xde) + make_modrm_sib(oper0, reg_bits{ 4 }); }

    constexpr decltype(auto) fsubrp() noexcept { using namespace details; return details::make_static_bytecode(0xde, 0xe1); }
    ...
    constexpr decltype(auto) fsubp(details::st oper0) noexcept { using namespace details; return make_static_bytecode(0xde) + make_modrm_sib(oper0, reg_bits{ 5 }); }

    constexpr decltype(auto) fsubp() noexcept { using namespace details; return details::make_static_bytecode(0xde, 0xe9); }
    ...
    constexpr decltype(auto) fdivrp(details::st oper0) noexcept { using namespace details; return make_static_bytecode(0xde) + make_modrm_sib(oper0, reg_bits{ 6 }); }

    constexpr decltype(auto) fdivrp() noexcept { using namespace details; return details::make_static_bytecode(0xde, 0xf1); }
    ...
    constexpr decltype(auto) fdivp(details::st oper0) noexcept { using namespace details; return make_static_bytecode(0xde) + make_modrm_sib(oper0, reg_bits{ 7 }); }

    constexpr decltype(auto) fdivp() noexcept { using namespace details; return details::make_static_bytecode(0xde, 0xf9); }
    ...
    constexpr decltype(auto) ffreep(details::st oper0) noexcept { using namespace details; return make_static_bytecode(0xdf) + make_modrm_sib(oper0, reg_bits{ 0 }); }
    ...
    constexpr decltype(auto) fnstsw(details::ax_t) noexcept { return details::make_static_bytecode(0xdf, 0xe0); }

    constexpr decltype(auto) fstsw(details::ax_t) noexcept { return details::make_static_bytecode(0x9b, 0xdf, 0xe0); }
    ...
    constexpr decltype(auto) fucomip(details::st oper0) noexcept { using namespace details; return make_static_bytecode(0xdf) + make_modrm_sib(oper0, reg_bits{ 5 }); }
    ...
    constexpr decltype(auto) fcomip(details::st oper0) noexcept { using namespace details; return make_static_bytecode(0xdf) + make_modrm_sib(oper0, reg_bits{ 6 }); }
    ...
    constexpr decltype(auto) in(details::al_t, details::imm8_t oper1) noexcept { using namespace details; return make_static_bytecode(0xe4) + make_imm(oper1); }

    constexpr decltype(auto) in(details::eax_t, details::imm8_t oper1) noexcept { using namespace details; return make_static_bytecode(0xe5) + make_imm(oper1); }

    constexpr decltype(auto) out(details::imm8_t oper0, details::al_t) noexcept { using namespace details; return make_static_bytecode(0xe6) + make_imm(oper0); }

    constexpr decltype(auto) out(details::imm8_t oper0, details::eax_t) noexcept { using namespace details; return make_static_bytecode(0xe7) + make_imm(oper0); }
...
#ifdef CASM_X32
    template<class oper0_t, std::enable_if_t<details::is_m16_48_v<oper0_t>, std::nullptr_t> = nullptr> constexpr decltype(auto) jmp(oper0_t const& oper0) noexcept { using namespace details; return make_segment_prefix(oper0) + make_address_size_prefix(oper0) + make_static_bytecode(0xea) + make_modrm_sib(oper0); }
#endif
    ...
    constexpr decltype(auto) in(details::al_t, details::dx_t) noexcept { return details::make_static_bytecode(0xec); }

    constexpr decltype(auto) in(details::eax_t, details::dx_t) noexcept { return details::make_static_bytecode(0xed); }

    constexpr decltype(auto) out(details::dx_t, details::al_t) noexcept { return details::make_static_bytecode(0xee); }

    constexpr decltype(auto) out(details::dx_t, details::eax_t) noexcept { return details::make_static_bytecode(0xef); }

    constexpr decltype(auto) lock() noexcept { using namespace details; return details::make_static_bytecode(0xf0); }

    constexpr decltype(auto) int1() noexcept { using namespace details; return details::make_static_bytecode(0xf1); }

    constexpr decltype(auto) icebp() noexcept { using namespace details; return details::make_static_bytecode(0xf1); }

    constexpr decltype(auto) repnz() noexcept { using namespace details; return details::make_static_bytecode(0xf2); }

    constexpr decltype(auto) repne() noexcept { using namespace details; return details::make_static_bytecode(0xf2); }

    constexpr decltype(auto) repz() noexcept { using namespace details; return details::make_static_bytecode(0xf3); }

    constexpr decltype(auto) repe() noexcept { using namespace details; return details::make_static_bytecode(0xf3); }

    constexpr decltype(auto) rep() noexcept { using namespace details; return details::make_static_bytecode(0xf3); }

    constexpr decltype(auto) hlt() noexcept { using namespace details; return details::make_static_bytecode(0xf4); }

    constexpr decltype(auto) cmc() noexcept { using namespace details; return details::make_static_bytecode(0xf5); }
    ...
    constexpr decltype(auto) clc() noexcept { using namespace details; return details::make_static_bytecode(0xf8); }

    constexpr decltype(auto) stc() noexcept { using namespace details; return details::make_static_bytecode(0xf9); }

    constexpr decltype(auto) cli() noexcept { using namespace details; return details::make_static_bytecode(0xfa); }

    constexpr decltype(auto) sti() noexcept { using namespace details; return details::make_static_bytecode(0xfb); }

    constexpr decltype(auto) cld() noexcept { using namespace details; return details::make_static_bytecode(0xfc); }

    constexpr decltype(auto) std_() noexcept { using namespace details; return details::make_static_bytecode(0xfd); }
...
#ifdef CASM_X64
    template<class oper0_t, std::enable_if_t<details::is_rm64_v<oper0_t>, std::nullptr_t> = nullptr> constexpr decltype(auto) call(oper0_t const& oper0) noexcept { using namespace details; return make_segment_prefix(oper0) + make_address_size_prefix(oper0) + make_static_bytecode(0xff) + make_modrm_sib(oper0, reg_bits{ 2 }); }
#endif
...
#ifdef CASM_X64
    template<class oper0_t, std::enable_if_t<details::is_rm64_v<oper0_t>, std::nullptr_t> = nullptr> constexpr decltype(auto) jmp(oper0_t const& oper0) noexcept { using namespace details; return make_segment_prefix(oper0) + make_address_size_prefix(oper0) + make_static_bytecode(0xff) + make_modrm_sib(oper0, reg_bits{ 4 }); }
#endif
    ...
    template<class oper0_t, std::enable_if_t<details::is_r16_32_v<oper0_t>, std::nullptr_t> = nullptr> constexpr decltype(auto) sldt(oper0_t const& oper0) noexcept { using namespace details; return make_oper_size_prefix(oper0) + make_static_bytecode(0x0f, 0x00) + make_modrm_sib(oper0, reg_bits{ 0 }); }
    ...
    template<class oper0_t, std::enable_if_t<details::is_r16_32_64_v<oper0_t>, std::nullptr_t> = nullptr> constexpr decltype(auto) str(oper0_t const& oper0) noexcept { using namespace details; return make_oper_size_prefix(oper0) + make_rex(oper0) + make_static_bytecode(0x0f, 0x00) + make_modrm_sib(oper0, reg_bits{ 1 }); }
    ...
    constexpr decltype(auto) vmcall() noexcept { using namespace details; return details::make_static_bytecode(0x0f, 0x01, 0xc1); }

    constexpr decltype(auto) vmlaunch() noexcept { using namespace details; return details::make_static_bytecode(0x0f, 0x01, 0xc2); }

    constexpr decltype(auto) vmresume() noexcept { using namespace details; return details::make_static_bytecode(0x0f, 0x01, 0xc3); }

    constexpr decltype(auto) vmxoff() noexcept { using namespace details; return details::make_static_bytecode(0x0f, 0x01, 0xc4); }
    ...
    constexpr decltype(auto) monitor() noexcept { using namespace details; return details::make_static_bytecode(0x0f, 0x01, 0xc8); }

    constexpr decltype(auto) mwait() noexcept { using namespace details; return details::make_static_bytecode(0x0f, 0x01, 0xc9); }
    ...
    constexpr decltype(auto) xgetbv() noexcept { using namespace details; return details::make_static_bytecode(0x0f, 0x01, 0xd0); }

    constexpr decltype(auto) xsetbv() noexcept { using namespace details; return details::make_static_bytecode(0x0f, 0x01, 0xd1); }
    ...
    template<class oper0_t, std::enable_if_t<details::is_r16_32_64_v<oper0_t>, std::nullptr_t> = nullptr> constexpr decltype(auto) smsw(oper0_t const& oper0) noexcept { using namespace details; return make_oper_size_prefix(oper0) + make_rex(oper0) + make_static_bytecode(0x0f, 0x01) + make_modrm_sib(oper0, reg_bits{ 4 }); }
...
#ifdef CASM_X64
    constexpr decltype(auto) swapgs() noexcept { using namespace details; return details::make_static_bytecode(0x0f, 0x01, 0xf8); }
#endif

    constexpr decltype(auto) rdtscp() noexcept { using namespace details; return details::make_static_bytecode(0x0f, 0x01, 0xf9); }
...
#ifdef CASM_X64
    constexpr decltype(auto) syscall_() noexcept { using namespace details; return details::make_static_bytecode(0x0f, 0x05); }
#endif

    constexpr decltype(auto) clts() noexcept { using namespace details; return details::make_static_bytecode(0x0f, 0x06); }

    constexpr decltype(auto) sysret() noexcept { using namespace details; return details::make_static_bytecode(0x0f, 0x07); }

    constexpr decltype(auto) invd() noexcept { using namespace details; return details::make_static_bytecode(0x0f, 0x08); }

    constexpr decltype(auto) wbinvd() noexcept { using namespace details; return details::make_static_bytecode(0x0f, 0x09); }

    constexpr decltype(auto) ud2() noexcept { using namespace details; return details::make_static_bytecode(0x0f, 0x0b); }

    template<class oper0_t, class oper1_t, std::enable_if_t<details::is_xmm_v<oper0_t> and details::is_xmmm128_v<oper1_t>, std::nullptr_t> = nullptr> constexpr decltype(auto) movups(oper0_t oper0, oper1_t const& oper1) noexcept { using namespace details; return make_segment_prefix(oper1) + make_address_size_prefix(oper1) + make_rex_w(oper1, oper0) + make_static_bytecode(0x0f, 0x10) + make_modrm_sib(oper1, oper0); }
...
#ifdef CASM_X64
    template<class oper0_t, std::enable_if_t<details::is_r64_v<oper0_t>, std::nullptr_t> = nullptr> constexpr decltype(auto) mov(oper0_t oper0, details::cr oper1) noexcept { using namespace details; return make_static_bytecode(0x0f, 0x20) + make_modrm_sib(oper0, oper1); }

    template<class oper0_t, std::enable_if_t<details::is_r64_v<oper0_t>, std::nullptr_t> = nullptr> constexpr decltype(auto) mov(oper0_t oper0, details::dr oper1) noexcept { using namespace details; return make_static_bytecode(0x0f, 0x21) + make_modrm_sib(oper0, oper1); }

    template<class oper1_t, std::enable_if_t<details::is_r64_v<oper1_t>, std::nullptr_t> = nullptr> constexpr decltype(auto) mov(details::cr oper0, oper1_t oper1) noexcept { using namespace details; return make_static_bytecode(0x0f, 0x22) + make_modrm_sib(oper1, oper0); }

    template<class oper1_t, std::enable_if_t<details::is_r64_v<oper1_t>, std::nullptr_t> = nullptr> constexpr decltype(auto) mov(details::dr oper0, oper1_t oper1) noexcept { using namespace details; return make_static_bytecode(0x0f, 0x23) + make_modrm_sib(oper1, oper0); }
#endif

#ifdef CASM_X32
    template<class oper0_t, std::enable_if_t<details::is_r32_v<oper0_t>, std::nullptr_t> = nullptr> constexpr decltype(auto) mov(oper0_t oper0, details::cr oper1) noexcept { using namespace details; return make_static_bytecode(0x0f, 0x20) + make_modrm_sib(oper0, oper1); }

    template<class oper0_t, std::enable_if_t<details::is_r32_v<oper0_t>, std::nullptr_t> = nullptr> constexpr decltype(auto) mov(oper0_t oper0, details::dr oper1) noexcept { using namespace details; return make_static_bytecode(0x0f, 0x21) + make_modrm_sib(oper0, oper1); }

    template<class oper1_t, std::enable_if_t<details::is_r32_v<oper1_t>, std::nullptr_t> = nullptr> constexpr decltype(auto) mov(details::cr oper0, oper1_t oper1) noexcept { using namespace details; return make_static_bytecode(0x0f, 0x22) + make_modrm_sib(oper0, oper1); }

    template<class oper1_t, std::enable_if_t<details::is_r32_v<oper1_t>, std::nullptr_t> = nullptr> constexpr decltype(auto) mov(details::dr oper0, oper1_t oper1) noexcept { using namespace details; return make_static_bytecode(0x0f, 0x23) + make_modrm_sib(oper0, oper1); }
#endif
    ...
    constexpr decltype(auto) wrmsr() noexcept { using namespace details; return details::make_static_bytecode(0x0f, 0x30); }

    constexpr decltype(auto) rdtsc() noexcept { using namespace details; return details::make_static_bytecode(0x0f, 0x31); }

    constexpr decltype(auto) rdmsr() noexcept { using namespace details; return details::make_static_bytecode(0x0f, 0x32); }

    constexpr decltype(auto) rdpmc() noexcept { using namespace details; return details::make_static_bytecode(0x0f, 0x33); }

    constexpr decltype(auto) sysenter() noexcept { using namespace details; return details::make_static_bytecode(0x0f, 0x34); }

    constexpr decltype(auto) sysexit() noexcept { using namespace details; return details::make_static_bytecode(0x0f, 0x35); }

    constexpr decltype(auto) getsec() noexcept { using namespace details; return details::make_static_bytecode(0x0f, 0x37); }

#ifdef CASM_X32
    template<class oper1_t, std::enable_if_t<details::is_mmm64_v<oper1_t>, std::nullptr_t> = nullptr> constexpr decltype(auto) pshufb(details::mm oper0, oper1_t const& oper1) noexcept { using namespace details; return make_segment_prefix(oper1) + make_oper_size_prefix(oper0) + make_address_size_prefix(oper1) + make_static_bytecode(0x0f, 0x38, 0x00) + make_modrm_sib(oper1, oper0); }
...
#ifdef CASM_X64
    template<class oper1_t, std::enable_if_t<details::is_r64_v<oper1_t>, std::nullptr_t> = nullptr> constexpr decltype(auto) movq(details::mm oper0, oper1_t oper1) noexcept { using namespace details; return make_rex(oper1) + make_static_bytecode(0x0f, 0x6e) + make_modrm_sib(oper1, oper0); }
#endif
    ...
    constexpr decltype(auto) movq(details::mm oper0, details::mm oper1) noexcept { using namespace details; return make_static_bytecode(0x0f, 0x6f) + make_modrm_sib(oper1, oper0); }
    ...
    constexpr decltype(auto) psrlw(details::mm oper0, details::imm8_t oper1) noexcept { using namespace details; return make_static_bytecode(0x0f, 0x71) + make_modrm_sib(oper0, reg_bits{ 2 }) + make_imm(oper1); }

    template<class oper0_t, std::enable_if_t<details::is_xmm_v<oper0_t>, std::nullptr_t> = nullptr> constexpr decltype(auto) psrlw(oper0_t oper0, details::imm8_t oper1) noexcept { using namespace details; return make_oper_size_prefix(oper0) + make_static_bytecode(0x0f, 0x71) + make_modrm_sib(oper0, reg_bits{ 2 }) + make_imm(oper1); }

    constexpr decltype(auto) psraw(details::mm oper0, details::imm8_t oper1) noexcept { using namespace details; return make_static_bytecode(0x0f, 0x71) + make_modrm_sib(oper0, reg_bits{ 4 }) + make_imm(oper1); }

    template<class oper0_t, std::enable_if_t<details::is_xmm_v<oper0_t>, std::nullptr_t> = nullptr> constexpr decltype(auto) psraw(oper0_t oper0, details::imm8_t oper1) noexcept { using namespace details; return make_oper_size_prefix(oper0) + make_static_bytecode(0x0f, 0x71) + make_modrm_sib(oper0, reg_bits{ 4 }) + make_imm(oper1); }

    constexpr decltype(auto) psllw(details::mm oper0, details::imm8_t oper1) noexcept { using namespace details; return make_static_bytecode(0x0f, 0x71) + make_modrm_sib(oper0, reg_bits{ 6 }) + make_imm(oper1); }

    template<class oper0_t, std::enable_if_t<details::is_xmm_v<oper0_t>, std::nullptr_t> = nullptr> constexpr decltype(auto) psllw(oper0_t oper0, details::imm8_t oper1) noexcept { using namespace details; return make_oper_size_prefix(oper0) + make_static_bytecode(0x0f, 0x71) + make_modrm_sib(oper0, reg_bits{ 6 }) + make_imm(oper1); }

    constexpr decltype(auto) psrld(details::mm oper0, details::imm8_t oper1) noexcept { using namespace details; return make_static_bytecode(0x0f, 0x72) + make_modrm_sib(oper0, reg_bits{ 2 }) + make_imm(oper1); }

    template<class oper0_t, std::enable_if_t<details::is_xmm_v<oper0_t>, std::nullptr_t> = nullptr> constexpr decltype(auto) psrld(oper0_t oper0, details::imm8_t oper1) noexcept { using namespace details; return make_oper_size_prefix(oper0) + make_static_bytecode(0x0f, 0x72) + make_modrm_sib(oper0, reg_bits{ 2 }) + make_imm(oper1); }

    constexpr decltype(auto) psrad(details::mm oper0, details::imm8_t oper1) noexcept { using namespace details; return make_static_bytecode(0x0f, 0x72) + make_modrm_sib(oper0, reg_bits{ 4 }) + make_imm(oper1); }

    template<class oper0_t, std::enable_if_t<details::is_xmm_v<oper0_t>, std::nullptr_t> = nullptr> constexpr decltype(auto) psrad(oper0_t oper0, details::imm8_t oper1) noexcept { using namespace details; return make_oper_size_prefix(oper0) + make_static_bytecode(0x0f, 0x72) + make_modrm_sib(oper0, reg_bits{ 4 }) + make_imm(oper1); }

    constexpr decltype(auto) pslld(details::mm oper0, details::imm8_t oper1) noexcept { using namespace details; return make_static_bytecode(0x0f, 0x72) + make_modrm_sib(oper0, reg_bits{ 6 }) + make_imm(oper1); }

    template<class oper0_t, std::enable_if_t<details::is_xmm_v<oper0_t>, std::nullptr_t> = nullptr> constexpr decltype(auto) pslld(oper0_t oper0, details::imm8_t oper1) noexcept { using namespace details; return make_oper_size_prefix(oper0) + make_static_bytecode(0x0f, 0x72) + make_modrm_sib(oper0, reg_bits{ 6 }) + make_imm(oper1); }

    constexpr decltype(auto) psrlq(details::mm oper0, details::imm8_t oper1) noexcept { using namespace details; return make_static_bytecode(0x0f, 0x73) + make_modrm_sib(oper0, reg_bits{ 2 }) + make_imm(oper1); }

    template<class oper0_t, std::enable_if_t<details::is_xmm_v<oper0_t>, std::nullptr_t> = nullptr> constexpr decltype(auto) psrlq(oper0_t oper0, details::imm8_t oper1) noexcept { using namespace details; return make_oper_size_prefix(oper0) + make_static_bytecode(0x0f, 0x73) + make_modrm_sib(oper0, reg_bits{ 2 }) + make_imm(oper1); }

    template<class oper0_t, std::enable_if_t<details::is_xmm_v<oper0_t>, std::nullptr_t> = nullptr> constexpr decltype(auto) psrldq(oper0_t oper0, details::imm8_t oper1) noexcept { using namespace details; return make_oper_size_prefix(oper0) + make_static_bytecode(0x0f, 0x73) + make_modrm_sib(oper0, reg_bits{ 3 }) + make_imm(oper1); }

    constexpr decltype(auto) psllq(details::mm oper0, details::imm8_t oper1) noexcept { using namespace details; return make_static_bytecode(0x0f, 0x73) + make_modrm_sib(oper0, reg_bits{ 6 }) + make_imm(oper1); }

    template<class oper0_t, std::enable_if_t<details::is_xmm_v<oper0_t>, std::nullptr_t> = nullptr> constexpr decltype(auto) psllq(oper0_t oper0, details::imm8_t oper1) noexcept { using namespace details; return make_oper_size_prefix(oper0) + make_static_bytecode(0x0f, 0x73) + make_modrm_sib(oper0, reg_bits{ 6 }) + make_imm(oper1); }

    template<class oper0_t, std::enable_if_t<details::is_xmm_v<oper0_t>, std::nullptr_t> = nullptr> constexpr decltype(auto) pslldq(oper0_t oper0, details::imm8_t oper1) noexcept { using namespace details; return make_oper_size_prefix(oper0) + make_static_bytecode(0x0f, 0x73) + make_modrm_sib(oper0, reg_bits{ 7 }) + make_imm(oper1); }
    ...
    constexpr decltype(auto) emms() noexcept { using namespace details; return details::make_static_bytecode(0x0f, 0x77); }
...
#undef CASM_X64
    ...
    constexpr decltype(auto) push(details::fs_t) noexcept { return details::make_static_bytecode(0x0f, 0xa0); }

    constexpr decltype(auto) pop(details::fs_t) noexcept { return details::make_static_bytecode(0x0f, 0xa1); }

    constexpr decltype(auto) cpuid() noexcept { using namespace details; return details::make_static_bytecode(0x0f, 0xa2); }
    ...
    constexpr decltype(auto) push(details::gs_t) noexcept { return details::make_static_bytecode(0x0f, 0xa8); }

    constexpr decltype(auto) pop(details::gs_t) noexcept { return details::make_static_bytecode(0x0f, 0xa9); }

    constexpr decltype(auto) rsm() noexcept { using namespace details; return details::make_static_bytecode(0x0f, 0xaa); }
    ...
    constexpr decltype(auto) lfence() noexcept { using namespace details; return details::make_static_bytecode(0x0f, 0xae); }
    ...
    constexpr decltype(auto) mfence() noexcept { using namespace details; return details::make_static_bytecode(0x0f, 0xae); }

    constexpr decltype(auto) sfence() noexcept { using namespace details; return details::make_static_bytecode(0x0f, 0xae); }
    ...
    template<class oper0_t, class oper1_t, std::enable_if_t<details::is_m32_64_v<oper0_t> and details::is_r32_64_v<oper1_t>, std::nullptr_t> = nullptr> constexpr decltype(auto) movnti(oper0_t const& oper0, oper1_t oper1) noexcept { using namespace details; static_assert(is_same_oper_size_v<oper0_t, oper1_t>); return make_segment_prefix(oper0) + make_address_size_prefix(oper0) + make_oper_size_prefix(oper1) + make_rex(oper0, oper1) + make_static_bytecode(0x0f, 0xc3) + make_modrm_sib(oper0, oper1); }

    template<class oper1_t, std::enable_if_t<details::is_r32_v<oper1_t>, std::nullptr_t> = nullptr> constexpr decltype(auto) pinsrw(details::mm oper0, oper1_t oper1, details::imm8_t oper2) noexcept { using namespace details; return make_rex(oper1) + make_static_bytecode(0x0f, 0xc4) + make_modrm_sib(oper0, oper1) + make_imm(oper2); }

    template<class oper1_t, std::enable_if_t<details::is_m16_v<oper1_t>, std::nullptr_t> = nullptr> constexpr decltype(auto) pinsrw(details::mm oper0, oper1_t const& oper1, details::imm8_t oper2) noexcept { using namespace details; return make_rex(oper1) + make_static_bytecode(0x0f, 0xc4) + make_modrm_sib(oper1, oper0) + make_imm(oper2); }
    ...
    template<class oper0_t, class oper1_t, std::enable_if_t<details::is_xmm_v<oper0_t> and details::is_m16_v<oper1_t>, std::nullptr_t> = nullptr> constexpr decltype(auto) pinsrw(oper0_t oper0, oper1_t const& oper1, details::imm8_t oper2) noexcept { using namespace details; return make_oper_size_prefix(oper0) + make_rex(oper1) + make_static_bytecode(0x0f, 0xc4) + make_modrm_sib(oper1, oper0) + make_imm(oper2); }

    template<class oper0_t, std::enable_if_t<details::is_r32_v<oper0_t>, std::nullptr_t> = nullptr> constexpr decltype(auto) pextrw(oper0_t oper0, details::mm oper1, details::imm8_t oper2) noexcept { using namespace details; return make_rex(oper0) + make_static_bytecode(0x0f, 0xc5) + make_modrm_sib(oper1, oper0) + make_imm(oper2); }
    ...
    template<class oper0_t, std::enable_if_t<details::is_r32_v<oper0_t>, std::nullptr_t> = nullptr> constexpr decltype(auto) bswap(oper0_t r) noexcept { using namespace details; auto opcode = make_static_bytecode(0x0f, 0xc8); opcode.at(opcode.size() - 1) += r.n(); return opcode; }
    ...
    template<class oper0_t, std::enable_if_t<details::is_xmm_v<oper0_t>, std::nullptr_t> = nullptr> constexpr decltype(auto) movq2dq(oper0_t oper0, details::mm oper1) noexcept { using namespace details; return make_oper_size_prefix(oper0) + make_static_bytecode(0xf3) + make_rex_w(oper0) + make_static_bytecode(0x0f, 0xd6) + make_modrm_sib(oper0, oper1); }

    template<class oper1_t, std::enable_if_t<details::is_xmm_v<oper1_t>, std::nullptr_t> = nullptr> constexpr decltype(auto) movdq2q(details::mm oper0, oper1_t oper1) noexcept { using namespace details; return make_static_bytecode(0xf2) + make_rex_w(oper1, oper0) + make_static_bytecode(0x0f, 0xd6) + make_modrm_sib(oper1, oper0); }

    template<class oper0_t, std::enable_if_t<details::is_r32_v<oper0_t>, std::nullptr_t> = nullptr> constexpr decltype(auto) pmovmskb(oper0_t oper0, details::mm oper1) noexcept { using namespace details; return make_rex(oper0) + make_static_bytecode(0x0f, 0xd7) + make_modrm_sib(oper1, oper0); }

    template<class oper0_t, class oper1_t, std::enable_if_t<details::is_r32_v<oper0_t> and details::is_xmm_v<oper1_t>, std::nullptr_t> = nullptr> constexpr decltype(auto) pmovmskb(oper0_t oper0, oper1_t oper1) noexcept { using namespace details; return make_oper_size_prefix(oper1) + make_rex(oper1) + make_static_bytecode(0x0f, 0xd7) + make_modrm_sib(oper0, oper1); }
                    ...
                    details::visit_at(mnemonics, i, [i, this](auto&& mnemonic) mutable
                        {
                            ...
                            else if constexpr (details::is_static_bytecode_v<decltype(mnemonic)>)
                            {
        ...
        constexpr assembler(tuple_t<ts...>&& mnemonics) noexcept
        {
            ...
            for (std::size_t i = 0; i < std::tuple_size_v<std::decay_t<decltype(mnemonics)>>; ++ i)
            {
                details::visit_at(mnemonics, i, [i, this, &rel_instruction_iterator](auto&& mnemonic) mutable
                    {
                        if constexpr (details::is_static_bytecode_v<decltype(mnemonic)>)
                        {
                            std::copy(mnemonic.begin(), mnemonic.end(), std::back_inserter(this->bytecode()));
                        }
                        else if constexpr (details::is_rel_instruct_v<decltype(mnemonic)>)
                        {
